...
int main()
{
	...
	//const char* modelPath = "E:/Programming/physics/DzhanibekovEffect/c++vs/Renderer/Resources/models/nut/scene.gltf";
	const char* modelPath = "E:/Programming/physics/DzhanibekovEffect/c++vs/Renderer/Resources/models/6by3top/scenehi.gltf";
	//const char* modelPath = "E:/Programming/physics/DzhanibekovEffect/c++vs/Renderer/Resources/models/nut/untitled.obj";
	...
	topobj->translate(glm::vec3(0.0, 0.0, 0.0));
	topobj->rotate(glm::quat(0.0, 1.0, 0.0, 1.0));
	topobj->setMomentum(glm::f64vec3(0.0, 30.0, 0.0));
	...
	//topobj1->setMomentum(glm::f64vec3(25.0, 0.0, 0.0));
