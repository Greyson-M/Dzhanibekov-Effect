...
void Model::setTranslation(glm::vec3 translation)
{
	...
	for (unsigned int i = 0; i < translationsMeshes.size(); i++)
	{
		translationsMeshes[i] = translation;
	}
}

void Model::setScale(glm::vec3 scale)
{
	// Set the scale of all meshes
	for (unsigned int i = 0; i < scalesMeshes.size(); i++)
	{
